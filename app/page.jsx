...
const PROJECTS = [
  ...
  {
    slug: "engravia-admin",
    title: "Engravia Admin",
    year: "2023",
    kind: "Web Dashboard",
    aspect: "web",
    shots: ["/shots/engravia_admin_1.png", "/shots/engravia_admin_2.png", "/shots/engravia_admin_3.png", "/shots/engravia_admin_4.png"],
    accent: "#C4945A",
    tint: "rgba(196,148,90,0.08)",
    blurb: "Full merchant back-office — order management, product catalog, customer CRM, WhatsApp campaigns, and live inventory. Built alongside the storefront.",
